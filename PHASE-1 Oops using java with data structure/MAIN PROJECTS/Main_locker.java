...
public class Main_locker {
    ...
    void showPrimaryMenu() {
        ...
        try{
            ...
            System.out.println("Enter the value among them 1, 2 or 3");
            showPrimaryMenu();
        }
    }
    ...
    void showSecondaryMenu() {
        ...
        try{
            ...
            switch (option){
                ...
                default : System.out.println("Choose an alphabet to enter a, b, c or d");
            }
            showSecondaryMenu();
        }
        catch (Exception e){
            System.out.println("Choose an alphabet to enter a, b, c or d");
            showSecondaryMenu();
        }
    }
	...
	public static void main(String[] args) {
		...
		Main_locker  menu = new Main_locker ();
